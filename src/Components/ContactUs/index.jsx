...
export default function ContactPage() {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm(
          "service_twinbrothers1", // Replace with your actual service ID
          "template_9v41ay7", // Replace with your actual template ID
          formRef.current,
          "ehY0W_DblRAKvNLN8" // Replace with your actual public key
        )
        .then(
          (result) => {
