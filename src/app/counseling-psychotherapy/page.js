      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">Our Expert Therapists</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-md">
              <div className="h-48 bg-gradient-to-r from-indigo-500 to-purple-600 relative">
                ...
                <div className="absolute bottom-4 left-6 text-white">
                  <h3 className="text-2xl font-bold">Senior Therapist</h3>
                  <p className="text-indigo-100">Clinical Psychologist</p>
                </div>
              </div>
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  <Award className="w-5 h-5 text-indigo-600" />
                  <span className="text-gray-700 font-medium">Ph.D. in Clinical Psychology</span>
                </div>
                <p className="text-gray-600 mb-6">
                  Dr. Sharma specializes in cognitive behavioral therapy, trauma recovery, and anxiety disorders. With
                  over 10 years of experience, she provides compassionate care for adults and adolescents.
                </p>
                <div className="flex flex-wrap gap-2">
                  {["CBT", "Trauma", "Anxiety", "Depression", "PTSD"].map((tag, index) => (
                    <span
                      key={index}
            ...
            <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-md">
              <div className="h-48 bg-gradient-to-r from-purple-500 to-pink-600 relative">
                <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-black/50 to-transparent"></div>
                <div className="absolute bottom-4 left-6 text-white">
                  <h3 className="text-2xl font-bold">Licensed Therapist</h3>
                  <p className="text-purple-100">Marriage & Family Therapist</p>
                </div>
              </div>
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  <Award className="w-5 h-5 text-purple-600" />
                  <span className="text-gray-700 font-medium">M.A. in Marriage & Family Therapy</span>
                </div>
                <p className="text-gray-600 mb-6">
                  Rajesh specializes in couples counseling, family therapy, and relationship issues. His approach
                  integrates various therapeutic modalities to help clients build healthier relationships.
                </p>
                <div className="flex flex-wrap gap-2">
                  {["Couples", "Family", "Relationships", "Communication", "Conflict Resolution"].map((tag, index) => (
                    <span
                      key={index}
